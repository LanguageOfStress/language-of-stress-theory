...
Before presenting the theory, it is worth naming something that rarely appears as an assumption at all. Every major framework discussed above — Predictive Processing, Global Workspace Theory, Integrated Information Theory — begins from the same place: information. They differ substantially in what they say happens to information (it is minimized, broadcast, integrated), but they agree that information is what the brain fundamentally deals in, and that consciousness is therefore something that must arise from, emerge from, or be identical to some informational process. This starting point is so deeply embedded in the field that it typically appears not as a theoretical commitment but as the obvious beginning of any rigorous account.

It is, however, a choice — and one with structural consequences. Information, in the technical sense these frameworks employ, is normatively neutral. A bit is a bit whether it describes the location of a predator or the color of a wall. Information does not, by itself, care about anything. It does not threaten anything. It does not relieve anything. And because it cannot, no quantity of information — however integrated, broadcast, or hierarchically organized — contains within it any explanation of why processing should feel like anything rather than occurring entirely in the dark. The Hard Problem is not a puzzle arising within the information-primitive framework; it is a structural consequence of the framework's own starting point. The explanatory gap between "information is processed" and "processing feels like something" is permanent from within that framework, because the two things do not share the right kind of relationship. Feeling is not an informational property.

## **A Different Primitive**

The Language of Stress (LoS) starts from a different primitive: value. Not value in a sophisticated philosophical or moral sense, but value in the most basic sense available — the degree to which something is good or bad for this system, right now. We argue that the brain's foundational currency is not information but the felt quality of mattering, and that phenomenal experience is not what arises when information processing reaches sufficient complexity or integration. It is what prioritization feels like from the inside of a self-maintaining system that has something to lose. This reframe does not patch the Hard Problem — it dissolves it, by showing that the question "why does processing feel like anything?" contains a false premise: that processing and feeling are two separate things, one giving rise to the other. They are not. 

The Language of Stress identifies consciousness with a specific physical process in self-maintaining systems — one that makes testable predictions distinguishing it from existing frameworks. Unlike Predictive Processing, which treats the brain as building world models to represent reality accurately, LoS proposes the brain defends coherence: prediction serves prioritization of what matters to the Self, not representation for its own sake. We first present the theory's architecture, then demonstrate functional necessity through the zombie impossibility argument, then derive falsifiable predictions, building on the formal axiomatization established in Pace (2026, Canonical Axioms). The Hard Problem dissolves as a consequence.

# **Theoretical Framework**

To clarify how the theory relates conscious experience to cognition, it is useful to distinguish three analytically separable levels at which conscious systems are often described. First, an epistemic level concerns how a system determines what is true, relevant, or significant for it. In the Language of Stress framework, this epistemic function is not implemented by propositional evaluation or inference, but by the same valenced tension dynamics that constitute experience itself. Learned value topographies structure subjective truth by assigning valence to anticipated states, such that deviation is immediately known as stress and resolution as relief. Second, a phenomenal level concerns how these deviations are felt, instantiated as valenced tension dynamics that constitute conscious experience. Third, a cognitive level concerns higher-order processes such as abstraction, planning, attention, and reasoning, which operate over—and are constrained by—these underlying epistemic–phenomenal dynamics. The central claim of the Language of Stress is therefore that conscious experience is both epistemically primary and phenomenally primitive: irreducible to cognition, yet functionally indispensable to it.
